...
import by.epam.task03.logic.EquipSaxBuilder;
import by.epam.task03.logic.EquipStaxBuilder;
import java.io.File;
...
//    }
    ...
    private static void demarsh(){
        ...
        try {
            ...
            um.setSchema(schema);
            MotoEquip st = (MotoEquip) um.unmarshal(new File("src/task03/equip.xml"));
            System.out.println(st.getEquip().toString());
...
//            
            ...
            m.marshal(magaz, new FileOutputStream("equip_test.xml"));
